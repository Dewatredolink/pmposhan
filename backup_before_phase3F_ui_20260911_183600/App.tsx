...
type Page = 'dashboard'|'schoolProfile'|'menuPlanner'|'dailyMeal'|'stockReceipt'|'stockRegister'|'stockControls'|'monthlyVerification'|'adminDashboard'|'schoolCalendar'|'masterData'|'customReports'|'workbookRegisters'|'reports';
...
export default function App(){
  ...
  const navBase:[Page,keyof typeof t,string][]=[['dashboard','dashboard','🏠'],['schoolProfile','schoolProfile','🏫'],['menuPlanner','menuPlanner','📅'],['dailyMeal','dailyMeal','🍲'],['stockReceipt','stockReceipt','📦'],['stockRegister','stockRegister','📊'],['stockControls','stockControls','🧾'],['monthlyVerification','monthlyVerification','✅'],['adminDashboard','adminDashboard','📈'],['schoolCalendar','schoolCalendar','🗓️'],['masterData','masterData','⚙️'],['customReports','customReports','📥'],['workbookRegisters','workbookRegisters','📚'],['reports','reports','📄']];
  ...
  else if(page==='workbookRegisters') body=<WorkbookRegisters lang={lang} schools={schools} schoolId={schoolId} setSchoolId={setSchoolId}/>;
